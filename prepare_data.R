...
##Number of scheduled observations within each subject
nt <- 20
...
## 15-point Gauss-Kronrod rule for the integrals wit.hin the survival model
...
Data <- list(n = n, 
             ...
             ncF = nknots,
             nt = nt,
             nt.subj = c(0, rep(20, dim(data.id)[1])),
